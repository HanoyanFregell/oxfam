...
$produce_q = $mysql->query("select item.id,item.name,item.price,supplier.company_name,item.unit from item left join supplier on item.supplier_id = supplier.id where item.supplier_id = $supplier_id");
